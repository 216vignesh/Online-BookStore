...
$sql = "select author_writes_books.BookID, BooksWithMultipleEditionsAndISBNSold.isbn,                       author_writes_books.Author_name, author_writes_books.Book, BooksWithMultipleEditionsAndISBNSold.NumberOfCopiesSold, RATING_VIEWS.Rating, 
    Edition.price, Edition.Format 
from BooksWithMultipleEditionsAndISBNSold
INNER JOIN author_writes_books ON author_writes_books.BookID = BooksWithMultipleEditionsAndISBNSold.bid
INNER JOIN RATING_VIEWS ON RATING_VIEWS.bid = author_writes_books.BookID
INNER JOIN Info ON Info.bid = author_writes_books.BookID
INNER JOIN Edition ON Edition.bid = author_writes_books.BookID 
group by BooksWithMultipleEditionsAndISBNSold.title;
";
...
if(isset($_POST['add'])){
                ...
                $sql = "CALL getPopularBookByGenre('Young Adult');";
...
<body>
   ...
   <div class="add-button-wrapper widget-fingerprint-product-add-button">
    ...
    <section>
        <h1>Best Selling Editions</h1>
        <!-- TABLE CONSTRUCTION author_writes_books.BookID, BooksWithMultipleEditionsAndISBNSold.isbn,                       author_writes_books.Author_name, author_writes_books.Book, BooksWithMultipleEditionsAndISBNSold.NumberOfCopiesSold, RATING_VIEWS.Rating, Edition.price, Edition.Format 
                -->
        <table>
            <tr>
                <th>Book ID</th>
