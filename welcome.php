                  ...
                  <div class="row">
                     <div class="col-md-3">
                        <ul class="contat_infoma">
                           <li><i class="fa fa-phone" aria-hidden="true"></i> Call : +17745198265</li>
                        </ul>
                     </div>
                     <div class="col-md-6">
                           ...
                           <div class="row">
                              <div class="col-md-9">
                                 <div class="build_box">
                                    ...
                                    <br>
                                    <br>
                                    <a class="read_more conatct_btn" href="contact.html" role="button">Search</a>
                                 </div>
                              </div>
                           </div>
                        </div>
            ...
            <div class="row">
               <div class="col-md-3">
                  <div id="text_hover" class="const text_align_center">
                     ...
                     <span>Most Selling books</span>
                  </div>
               </div>
               <div class="col-md-3">
                  <div id="text_hover" class="const text_align_center">
                     <i><img src="images/ser2.png" alt="#"/></i>
                     <span>Award winning books</span>
                  </div>
               </div>
               <div class="col-md-3">
                  <div id="text_hover" class="const text_align_center">
                                    ...
                                    <div class="col-md-4">
                                       <div class="project">
                                          <div class="project_img">
                                             <figure><img src="images/ser1.png" alt="#"/></figure>
                                          </div>
                                          <div id="pro_ho" class="project_text">
                                             <h3>We provide you options for<br> largest selling books</h3>
                                             <p>Get to know about our most selling books this year and make your reading a lot more fun</p>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-4">
                                       <div class="project">
                                          <div class="project_img">
                                             <figure><img src="images/ser2.png" alt="#"/></figure>
                                          </div>
                                          <div id="pro_ho" class="project_text">
                                             <h3>We provide you to choose books<br> that has won more awards</h3>
                                             <p>There are multiple books that has won several awards which might interest you</p>
                                          </div>
                                       </div>
                                    </div>
                                    <!-- <div class="col-md-4">
